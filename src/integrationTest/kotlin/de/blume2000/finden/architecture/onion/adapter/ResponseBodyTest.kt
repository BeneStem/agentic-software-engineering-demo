...
class ResponseBodyTest {
  ...
  @ArchTest
  fun responseBodyClasses(classes: JavaClasses) =
    classes()
      .that().haveSimpleNameEndingWith(RESPONSE_BODY)
  ...
  @ArchTest
  fun responseBodyFields(classes: JavaClasses) =
    fields()
      .that().areDeclaredInClassesThat().haveSimpleNameEndingWith(RESPONSE_BODY)
